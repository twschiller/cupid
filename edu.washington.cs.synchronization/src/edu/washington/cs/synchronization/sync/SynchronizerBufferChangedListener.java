...
import edu.washington.cs.synchronization.sync.task.internal.ITask;
...
public class SynchronizerBufferChangedListener implements IBufferChangedListener
{
    ...
    public void bufferChanged(BufferChangedEvent event)
    {
        ...
        {
            ITask bufferChangedTask = new BufferChangedTask(event, synchronizer);
