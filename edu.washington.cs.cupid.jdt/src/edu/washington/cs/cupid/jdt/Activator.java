...
import edu.washington.cs.cupid.jdt.compiler.CompilerMessageCapability;
...
public class Activator extends AbstractUIPlugin implements ICapabilityPublisher {
	...
	public ICapability<?, ?>[] publish() {
		return new ICapability<?,?>[]{ new CompilerMessageCapability(), new CompilerMessagePredicate()};
	}
