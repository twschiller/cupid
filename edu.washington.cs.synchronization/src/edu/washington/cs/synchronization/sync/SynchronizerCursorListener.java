...
import edu.washington.cs.synchronization.sync.internal.ICursorChangedListener;
import edu.washington.cs.synchronization.sync.internal.ICursorChangedNotifier;
import edu.washington.cs.util.eclipse.ResourceUtility;

public class SynchronizerCursorListener implements ISelectionListener, ICursorChangedNotifier 
{
    private final ArrayList<ICursorChangedListener> listeners_;
    ...
    {
        lastFile_ = null;
        listeners_ = new ArrayList <ICursorChangedListener>();
    }
...
//            System.out.println("Unknown selection type = " + selection.getClass());
    ...
    @Override
    public synchronized void addCursorChangedListener(ICursorChangedListener listener)
    {
    ...
    {
        for (ICursorChangedListener listener: listeners_)
