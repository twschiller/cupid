...
import edu.washington.cs.synchronization.sync.internal.IActiveFileChangedListener;
import edu.washington.cs.synchronization.sync.internal.IActiveFileChangedNotifier;
 ...
 * required. <br>
 * <br>
 * Synchronization part listener also acts as an {@link IActiveFileChangedNotifier}. Whenever the active project is
 ...
 */
public class SynchronizerPartListener implements IPartListener2, IActiveFileChangedNotifier
{
    /** singleton instance. */
    ...
    /** listener list. */
    private final ArrayList <IActiveFileChangedListener> listeners_ = new ArrayList <IActiveFileChangedListener>();
...
//        }
     ...
     */
    @Override
    public synchronized void addActiveFileChangedListener(IActiveFileChangedListener listener)
    {
    ...
    {
        for (IActiveFileChangedListener listener: listeners_)
